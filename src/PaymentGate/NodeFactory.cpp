...
MevaCoin::INode* NodeFactory::createNode(const std::string& daemonAddress, uint16_t daemonPort) {
  std::unique_ptr<MevaCoin::INode> node(new MevaCoin::NodeRpcProxy(daemonAddress, daemonPort));
