...
class WalletService {
public:
  WalletService(const MevaCoin::Currency& currency, System::Dispatcher& sys, MevaCoin::INode& node, MevaCoin::IWallet& wallet, const WalletConfiguration& conf, Logging::ILogger& logger);
