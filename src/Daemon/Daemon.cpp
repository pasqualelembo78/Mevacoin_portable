...
void print_genesis_tx_hex() {
  ...
  MevaCoin::Transaction tx = MevaCoin::CurrencyBuilder(logger).generateGenesisTransaction();
  MevaCoin::BinaryArray txb = MevaCoin::toBinaryArray(tx);
...
int main(int argc, char* argv[])
{
  ...
  try {
    ...
    MevaCoin::core ccore(currency, nullptr, logManager);
    ...
    ccore.set_mevacoin_protocol(&cprotocol);
    ...
    ccore.set_mevacoin_protocol(NULL);
