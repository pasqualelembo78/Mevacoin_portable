...
public:
  ...
  void updateTransaction(TransactionId transactionId, const MevaCoin::Transaction& tx, uint64_t amount, const std::list<TransactionOutputInformation>& usedOutputs);
