...
MinerManager::MinerManager(System::Dispatcher& dispatcher, const MevaCoin::MiningConfig& config, Logging::ILogger& logger) :
...
void MinerManager::adjustBlockTemplate(MevaCoin::Block& blockTemplate) const {
