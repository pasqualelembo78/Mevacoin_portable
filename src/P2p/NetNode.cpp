...
namespace MevaCoin
{
  namespace
  {
    ...
    const command_line::arg_descriptor<std::string> arg_p2p_bind_port      = {"p2p-bind-port", "Port for p2p network protocol", std::to_string(MevaCoin::P2P_DEFAULT_PORT)};
...
#undef INVOKE_HANDLER
  ...
  //----------------------------------------------------------------------------------- 
  void NodeServer::for_each_connection(std::function<void(MevaCoinConnectionContext&, PeerIdType)> f)
  {
