...
std::string encrypt(const std::string& plain, MevaCoin::CryptoContext& cryptoContext) {
  std::string cipher;
...
template<typename Object>
void serializeEncrypted(Object& obj, const std::string& name, MevaCoin::CryptoContext& cryptoContext, Common::IOutputStream& destination) {
...
std::string decrypt(const std::string& cipher, MevaCoin::CryptoContext& cryptoContext) {
  std::string plain;
...
template<typename Object>
void deserializeEncrypted(Object& obj, const std::string& name, MevaCoin::CryptoContext& cryptoContext, Common::IInputStream& source) {
...
void WalletSerializer::loadWallet(Common::IInputStream& source, const std::string& password, uint32_t version) {
  MevaCoin::CryptoContext cryptoContext;
...
void WalletSerializer::loadWalletV1Keys(MevaCoin::BinaryInputStreamSerializer& serializer) {
...
void WalletSerializer::loadWalletV1Details(MevaCoin::BinaryInputStreamSerializer& serializer) {
