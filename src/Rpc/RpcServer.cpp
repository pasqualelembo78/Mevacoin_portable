...
RpcServer::RpcServer(System::Dispatcher& dispatcher, Logging::ILogger& log, core& c, NodeServer& p2p, const IMevaCoinProtocolQuery& protocolQuery) :
...
bool RpcServer::on_getblocktemplate(const COMMAND_RPC_GETBLOCKTEMPLATE::request& req, COMMAND_RPC_GETBLOCKTEMPLATE::response& res) {
  ...
  PublicKey tx_pub_key = MevaCoin::getTransactionPublicKeyFromExtra(b.baseTransaction.extra);
