...
bool serialize(google::sparse_hash_map<K, V, Hash>& value, Common::StringView name, MevaCoin::ISerializer& serializer) {
  return serializeMap(value, name, serializer, [&value](size_t size) { value.resize(size); });
}

template<typename K, typename Hash>
bool serialize(google::sparse_hash_set<K, Hash>& value, Common::StringView name, MevaCoin::ISerializer& serializer) {
