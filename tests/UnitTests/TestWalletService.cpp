...
struct IWalletBaseStub : public MevaCoin::IWallet {
...
protected:
  ...
  std::unique_ptr<WalletService> createWalletService(MevaCoin::IWallet& wallet);
...
std::unique_ptr<WalletService> WalletServiceTest::createWalletService(MevaCoin::IWallet& wallet) {
